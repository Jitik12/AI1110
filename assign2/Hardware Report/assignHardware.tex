...
\begin{document}
	...
	%\setlist[enumerate,1]{before=\renewcommand\theequation{\theenumi.\arabic{equation}}
		...
		\title{
			%	\logo{
				Probability Hardware Report in \LaTeX
				%	}
		}
		\author{Shaik Armaan, cs22btech11051
		% <-this % stops a space
...
\begin{enumerate}
	...
	\begin{figure}[h]
		...
		\label{7474_IC}
	\end{figure}
    \item The out put of each D Flip Flop acts as the out put for the next Q and eventually the XOR gate will take in $D_{0}$ and $D_{3}$ as the inputs.
	...
	\item We now connected the power source to our circuit and we get the numbers.
...
\section{Output} 
	...
	\begin{figure}[h]
		\includegraphics[width=\linewidth]{images/output1.jpg}
		\caption{output}
		\label{output1}
	\end{figure}
	\begin{figure}[h]
		\includegraphics[width=\linewidth]{images/output2.jpg}
		\caption{output}
		\label{output2}
	\end{figure}
	\begin{figure}[h]
		\includegraphics[width=\linewidth]{images/output3.jpg}
		\caption{output3}
		\label{output3}
	\end{figure}
	\begin{figure}[h]
		\includegraphics[width=\linewidth]{images/output4.jpg}
		\caption{output4}
		\label{output4}
	\end{figure}
...
\section{Conclusion}
\begin{enumerate}
    \item We basically are shifting outputs of D Flip Flops as the input to the next D Flip Flop which happens 4 times on our case.
    \item Finally the XOR gate takes in the value of $D_{0}$ and $D_{3}$ as the input and gives out the finaly number.
    \item The decoder IC 7447 basically decodes the output of the XOR gate and gives the voltage only to those segments that need to be turned on.
    \item And finally the seven segement display displays the random(not quite) number.
\end{enumerate}
